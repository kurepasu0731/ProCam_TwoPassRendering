...
void TPGROpenCV::loadParameters()
{
	...
	//-シャッタースピード
	GetPrivateProfileStringA("shutterspeed", "shutter_high ", NULL, buf, sizeof(buf), "./parameter.ini");
	Shutter_high = atof(buf);
	GetPrivateProfileStringA("shutterspeed", "shutter_middle1  ", NULL, buf, sizeof(buf), "./parameter.ini");
	Shutter_middle1 = atof(buf);
	GetPrivateProfileStringA("shutterspeed", "shutter_middle2  ", NULL, buf, sizeof(buf), "./parameter.ini");
	Shutter_middle2 = atof(buf);
	GetPrivateProfileStringA("shutterspeed", "shutter_middle3  ", NULL, buf, sizeof(buf), "./parameter.ini");
	Shutter_middle3 = atof(buf);
	GetPrivateProfileStringA("shutterspeed", "shutter_low   ", NULL, buf, sizeof(buf), "./parameter.ini");
	Shutter_low = atof(buf);
	GetPrivateProfileStringA("shutterspeed", "shutter_lc", NULL, buf, sizeof(buf), "./parameter.ini");
	Shutter_LC = atof(buf);
	GetPrivateProfileStringA("shutterspeed", "shutter_ps", NULL, buf, sizeof(buf), "./parameter.ini");
	Shutter_PhaseShift = atof(buf);

	//-フレームレート
	GetPrivateProfileStringA("framerate", "framerate", NULL, buf, sizeof(buf), "./parameter.ini");
	Framerate = atof(buf);

	//-ゲイン
	GetPrivateProfileStringA("gain", "gain", NULL, buf, sizeof(buf), "./parameter.ini");
	Gain = atof(buf);

	//-ホワイトバランス
	GetPrivateProfileStringA("whitebalance", "red", NULL, buf, sizeof(buf), "./parameter.ini");
	Wb_Red = (unsigned int)atof(buf);
	GetPrivateProfileStringA("whitebalance", "blue", NULL, buf, sizeof(buf), "./parameter.ini");
